...
2. Multiply the input values.
3. Add the multiplication result to the previously accumulated value.
4. Store the updated result in the accumulator.
5. Repeat the process for subsequent input data.
...
- Signed and unsigned arithmetic support
